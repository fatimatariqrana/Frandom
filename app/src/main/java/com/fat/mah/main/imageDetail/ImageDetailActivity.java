...
package com.fat.mah.main.imageDetail;
...
import com.fat.mah.TouchImageView;

public class ImageDetailActivity extends BaseActivity<ImageDetailView, ImageDetailPresenter> implements ImageDetailView {   // when immage is displayed
