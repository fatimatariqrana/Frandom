...
package com.fat.mah.main.search;
...
import com.fat.mah.TabsPagerAdapter;
import com.fat.mah.main.base.BaseActivity;
import com.fat.mah.main.search.posts.SearchPostsFragment;
import com.fat.mah.main.search.users.SearchUsersFragment;
...
public class SearchActivity extends BaseActivity<SearchView, SearchPresenter> implements SearchView {
    ...
    private void initTabs() {
        ...
        tabsAdapter.addTab(SearchPostsFragment.class, argsPostsTab, "SEARCH POSTS");  //////////////////

        Bundle argsUsersTab = new Bundle();
        tabsAdapter.addTab(SearchUsersFragment.class, argsUsersTab, "SEARCH USERS");/////////////////////
